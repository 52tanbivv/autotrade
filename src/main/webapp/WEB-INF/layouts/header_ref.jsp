...
<header class="navbar navbar-default">
			...
			<ul class="dropdown-menu dropdown-custom dropdown-options">
				...
				<li>
					<button class="btn btn-sm btn-block btn-primary"
						id="options-header-top">Fixed Side/Header (Top)</button>
					<button class="btn btn-sm btn-block btn-primary"
						id="options-header-bottom">Fixed Side/Header (Bottom)</button>
				</li>
				<li class="dropdown-header text-center">Footer</li>
				<li>
					<div class="btn-group btn-group-justified btn-group-sm">
						<a href="javascript:void(0)" class="btn btn-primary"
							id="options-footer-static">Default</a> <a
							href="javascript:void(0)" class="btn btn-primary"
							id="options-footer-fixed">Fixed</a>
					</div>
				</li>
			</ul></li>
	...
	<ul class="nav navbar-nav-custom pull-right">
		...
		<li>
			...
			onclick="App.sidebar('toggle-sidebar-alt', 'toggle-other');"> <i
				class="gi gi-share_alt"></i> <span
		...
		<li class="dropdown"><a href="javascript:void(0)"
			...
			<ul class="dropdown-menu dropdown-custom dropdown-menu-right">
				...
				<li class="divider"></li>
				<li><a href="page_ready_user_profile.html"> <i
				...
				<li>
					<div class="alert alert-success alert-alt">
						<small>5 min ago</small><br> <i class="fa fa-thumbs-up fa-fw"></i>
						You had a new sale ($10)
					</div>
					<div class="alert alert-info alert-alt">
						<small>10 min ago</small><br> <i class="fa fa-arrow-up fa-fw"></i>
