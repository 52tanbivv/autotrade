export default {
  ...
  bind: function () {
    ...
    this.handleDragStart = function (e) {
      ...
      e.dataTransfer.setData('itemOne', e.target.id)
    ...
    this.handleDrop = function (e) {
      ...
      console.log('E==' + e.dataTransfer.getData('id') + ' target=' + e.target.id + ' this.vm._dragSrcEl=' + e.dataTransfer.getData('itemOne'))
      ...
      if (this.vm._dragSrcEl !== e.target) {
        if (typeof (this.vm[this.params.drop]) === 'function') {
          ...
          this.vm[this.params.drop].call(this, e.dataTransfer.getData('itemOne'), el)
        }
      }
      return false
    }.bind(this)
